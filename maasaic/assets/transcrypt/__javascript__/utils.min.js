...
$jscomp.polyfill=function(c,q,n,v){if(q){n=$jscomp.global;c=c.split(".");for(v=0;v<c.length-1;v++){var E=c[v];E in n||(n[E]={});n=n[E]}c=c[c.length-1];v=n[c];q=q(v);q!=v&&null!=q&&$jscomp.defineProperty(n,c,{configurable:!0,writable:!0,value:q})}};
$jscomp.polyfill("String.prototype.startsWith",function(c){return c?c:function(c,n){var q=$jscomp.checkStringArgs(this,c,"startsWith");c+="";var E=q.length,D=c.length;n=Math.max(0,Math.min(n|0,q.length));for(var I=0;I<D&&n<E;)if(q[n++]!=c[I++])return!1;return I>=D}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.symbolCounter_=0;
...
$jscomp.arrayIterator=function(c){var q=0;return $jscomp.iteratorPrototype(function(){return q<c.length?{done:!1,value:c[q++]}:{done:!0}})};$jscomp.iteratorPrototype=function(c){$jscomp.initSymbolIterator();c={next:c};c[$jscomp.global.Symbol.iterator]=function(){return this};return c};
$jscomp.polyfill("Array.from",function(c){return c?c:function(c,n,v){$jscomp.initSymbolIterator();n=null!=n?n:function(c){return c};var q=[],D=c[Symbol.iterator];if("function"==typeof D)for(c=D.call(c);!(D=c.next()).done;)q.push(n.call(v,D.value));else{D=c.length;for(var I=0;I<D;I++)q.push(n.call(v,c[I]))}return q}},"es6","es3");
...
typeof h||null!=h&&h.hasOwnProperty("__kwargtrans__"))h=!1;if(arguments.length){var f=arguments.length-1;if(arguments[f]&&arguments[f].hasOwnProperty("__kwargtrans__")){f=arguments[f--];for(var d in f)switch(d){case "iterable":a=f[d];break;case "key":b=f[d];break;case "reverse":h=f[d]}}}b?a.sort(function(a,h){if(arguments.length){var f=arguments.length-1;if(arguments[f]&&arguments[f].hasOwnProperty("__kwargtrans__")){f=arguments[f--];for(var d in f)switch(d){case "a":a=f[d];break;case "b":h=f[d]}}}return b(a)>
b(h)?1:-1}):a.sort();h&&a.reverse()},X=x("__Terminal__",[z],{__module__:"org.transcrypt.__standard__",get __init__(){return g(this,function(a){a.buffer="";try{a.element=document.getElementById("__terminal__")}catch(Ea){a.element=null}a.element&&(a.element.style.overflowX="auto",a.element.style.boxSizing="border-box",a.element.style.padding="5px",a.element.innerHTML="_")})},get print(){return g(this,function(a){var b=" ";var h="\n";if(arguments.length){var f=arguments.length-1;if(arguments[f]&&arguments[f].hasOwnProperty("__kwargtrans__")){var d=
arguments[f--],k;for(k in d)switch(k){case "self":a=d[k];break;case "sep":b=d[k];break;case "end":h=d[k]}}var c=p([].slice.apply(arguments).slice(1,f+1))}else c=p();a.buffer="{}{}{}".format(a.buffer,b.join(function(){for(var a=[],b=c,h=0;h<l(b);h++)a.append(y(b[h]));return a}()),h).__getslice__(-4096,null,1);a.element?(a.element.innerHTML=a.buffer.py_replace("\n","<br>").py_replace(" ","&nbsp"),a.element.scrollTop=a.element.scrollHeight):console.log(b.join(function(){for(var a=[],b=c,h=0;h<l(b);h++)a.append(y(b[h]));
return a}()))})},get input(){return g(this,function(a,b){if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].hasOwnProperty("__kwargtrans__")){h=arguments[h--];for(var f in h)switch(f){case "self":a=h[f];break;case "question":b=h[f]}}}a.print("{}".format(b),B({end:""}));f=window.prompt("\n".join(a.buffer.py_split("\n").__getslice__(-16,null,1)));a.print(f);return f})}}),za=X();a.AssertionError=n;a.AttributeError=h;a.DeprecationWarning=ya;a.Exception=b;a.IndexError=q;a.IterableError=
...
a.slice(2))};J(e,"",T(e.org.transcrypt.__base__));P=e.__envir__;J(e,"",T(e.org.transcrypt.__standard__));var Q=e.Exception,Aa=e.StopIteration,aa=e.ValueError,ha=e.KeyError,Ba=e.AssertionError,U=e.NotImplementedError,ia=e.IndexError,G=e.AttributeError,fa=e.py_TypeError,Ca=e.__sort__,Da=e.map;e.print=e.__terminal__.print;e.input=e.__terminal__.input;P.executor_name=P.transpiler_name;e.main={__file__:""};e.__except__=null;var B=function(a){a.__kwargtrans__=null;a.constructor=Object;return a};e.__kwargtrans__=
B;e.__globals__=function(a){return W(a,A)?a:A(a)};e.__super__=function(a,b){for(var d=0;d<a.__bases__.length;d++){var c=a.__bases__[d];if(b in c)return c[b]}throw new Q("Superclass method not found");};var H=function(a,b){b||(b=function(){});return{get:function(){return a(this)},set:function(a){b(this,a)},enumerable:!0}};e.property=H;var w=function(a,b,d){a.hasOwnProperty(b)||Object.defineProperty(a,b,d)};e.__setProperty__=w;e.assert=function(a,b){if(!a)throw Ba(b,Error());};e.__merge__=function(a,
b){var d={},c;for(c in a)d[c]=a[c];for(c in b)d[c]=b[c];return d};e.dir=function(a){var b=[],d;for(d in a)b.push(d.startsWith("py_")?d.slice(3):d);b.sort();return b};e.setattr=function(a,b,d){a[b]=d};e.getattr=function(a,b){return b in a?a[b]:a["py_"+b]};e.hasattr=function(a,b){try{return b in a||"py_"+b in a}catch(d){return!1}};e.delattr=function(a,b){b in a?delete a[b]:delete a["py_"+b]};var R=function(a,b){return void 0===b||null===b?!1:b.__contains__ instanceof Function?b.__contains__(a):b.indexOf?
-1<b.indexOf(a):b.hasOwnProperty(a)};e.__in__=R;var S=function(a){return a.startswith("__")&&a.endswith("__")||"constructor"==a||a.startswith("py_")};e.__specialattrib__=S;var l=function(a){if(void 0===a||null===a)return 0;if(a.__len__ instanceof Function)return a.__len__();if(void 0!==a.length)return a.length;var b=0,d;for(d in a)S(d)||b++;return b};e.len=l;e.__t__=c;var Y=function(a){if("inf"==a)return Infinity;if("-inf"==a)return-Infinity;if("nan"==a)return NaN;if(isNaN(parseFloat(a))){if(!1===
...
Uint8Array.prototype.__rmul__=Uint8Array.prototype.__mul__;e.str=y;String.prototype.__class__=y;y.__name__="str";y.__bases__=[z];String.prototype.__iter__=function(){new q(this)};String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').py_replace("\t","\\t").py_replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.endswith=function(a){if(a instanceof
...
e&&e.hasOwnProperty("__kwargtrans__"))e=null;Q.__init__(a,b,B({error:c}));a.pattern=C;a.flags=d;a.pos=e})}}),n=x("ReIndexError",[ia],{__module__:"re",get __init__(){return g(this,function(a){ia.__init__(a,"no such group")})}}),r=x("Match",[z],{__module__:"re",get __init__(){return g(this,function(a,b,c,d,e,g,K){if("undefined"==typeof K||null!=K&&K.hasOwnProperty("__kwargtrans__"))K=null;for(var f=E(b),h=0;h<l(f);h++){var k=f[h][0];b[k]=void 0==b[k]?null:b[k]}a._obj=b;a._pos=d;a._endpos=e;a._re=g;
a._string=c;a._namedGroups=K;a._lastindex=a._lastMatchGroup();a._lastgroup=null!==a._namedGroups?a._namedGroups[a._lastindex]:null})},get _getPos(){return g(this,function(a){return a._pos})},get _setPos(){return g(this,function(a,b){a=G("readonly attribute");a.__cause__=null;throw a;})},get _getEndPos(){return g(this,function(a){return a._endpos})},get _setEndPos(){return g(this,function(a,b){a=G("readonly attribute");a.__cause__=null;throw a;})},get _getRe(){return g(this,function(a){return a._re})},
get _setRe(){return g(this,function(a,b){a=G("readonly attribute");a.__cause__=null;throw a;})},get _getString(){return g(this,function(a){return a._string})},get _setString(){return g(this,function(a,b){a=G("readonly attribute");a.__cause__=null;throw a;})},get _getLastGroup(){return g(this,function(a){return a._lastgroup})},get _setLastGroup(){return g(this,function(a,b){a=G("readonly attribute");a.__cause__=null;throw a;})},get _getLastIndex(){return g(this,function(a){return a._lastindex})},get _setLastIndex(){return g(this,
function(a,b){a=G("readonly attribute");a.__cause__=null;throw a;})},get _lastMatchGroup(){return g(this,function(a){if(1<l(a._obj))for(var b=l(a._obj)-1;0<b;b--)if(null!==a._obj[b])return b;return null})},get expand(){return g(this,function(a,b){a=U();a.__cause__=null;throw a;})},get group(){return g(this,function(a){var b=p([].slice.apply(arguments).slice(1));var c=m([]);if(0<l(b))for(var h=0;h<l(b);h++){var d=b[h];if(L(d)===y)if(null!==a._namedGroups){if(!R(d,a._namedGroups.py_keys()))throw b=
n(),b.__cause__=null,b;c.append(a._obj[a._namedGroups[d]])}else throw b=U("No NamedGroups Available"),b.__cause__=null,b;else{if(d>=l(a._obj))throw b=n(),b.__cause__=null,b;c.append(a._obj[d])}}else c.append(a._obj[0]);return 1==l(c)?c[0]:p(c)})},get groups(){return g(this,function(a,b){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=null;if(1<l(a._obj)){a=a._obj.__getslice__(1,null,1);for(var c=[],f=0;f<l(a);f++){var h=a[f];c.append(null!==h?h:b)}return p(c)}return p()})},
get groupdict(){return g(this,function(a,b){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=null;if(null!==a._namedGroups){for(var c=A({}),f=a._namedGroups.py_items(),h=0;h<l(f);h++){var d=f[h],e=a._obj[d[1]];c[d[0]]=null!==e?e:b}return c}a=U("No NamedGroups Available");a.__cause__=null;throw a;})},get start(){return g(this,function(a,b){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=0;if(L(b)===y)if(null!==a._namedGroups){if(!R(b,a._namedGroups.py_keys()))throw a=
n(),a.__cause__=null,a;b=a._namedGroups[b]}else throw a=U("No NamedGroups Available"),a.__cause__=null,a;if(b>=l(a._obj))throw a=n(),a.__cause__=null,a;if(0==b)return a._obj.index;if(null!==a._obj[b]){if(b=t(v(a._obj[b]),a._re.flags).search(a._obj[0]))return a._obj.index+b.start();a=Q("Failed to find capture group");a.__cause__=null;throw a;}return-1})},get end(){return g(this,function(a,b){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=0;if(L(b)===y)if(null!==a._namedGroups){if(!R(b,
a._namedGroups.py_keys()))throw a=n(),a.__cause__=null,a;b=a._namedGroups[b]}else throw a=U("No NamedGroups Available"),a.__cause__=null,a;if(b>=l(a._obj))throw a=n(),a.__cause__=null,a;if(0==b)return a._obj.index+l(a._obj[0]);if(null!==a._obj[b]){if(b=t(v(a._obj[b]),a._re.flags).search(a._obj[0]))return a._obj.index+b.end();a=Q("Failed to find capture group");a.__cause__=null;throw a;}return-1})},get span(){return g(this,function(a,b){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=
0;return p([a.start(b),a.end(b)])})}});Object.defineProperty(r,"pos",H.call(r,r._getPos,r._setPos));Object.defineProperty(r,"endpos",H.call(r,r._getEndPos,r._setEndPos));Object.defineProperty(r,"re",H.call(r,r._getRe,r._setRe));Object.defineProperty(r,"string",H.call(r,r._getString,r._setString));Object.defineProperty(r,"lastgroup",H.call(r,r._getLastGroup,r._setLastGroup));Object.defineProperty(r,"lastindex",H.call(r,r._getLastIndex,r._setLastIndex));var u=x("Regex",[z],{__module__:"re",get __init__(){return g(this,
function(a,b,c){0<(c&256)||(c|=32);a._flags=c;var f=a._compileWrapper(b,c);a._jsFlags=f[0];a._obj=f[1];a._jspattern=b;a._pypattern=b;f=a._compileWrapper(b+"|",c);a._groups=f[1].exec("").length-1;a._groupindex=null})},get _getPattern(){return g(this,function(a){return a._pypattern.py_replace("\\","\\\\")})},get _setPattern(){return g(this,function(a,b){a=G("readonly attribute");a.__cause__=null;throw a;})},get _getFlags(){return g(this,function(a){return a._flags})},get _setFlags(){return g(this,function(a,
b){a=G("readonly attribute");a.__cause__=null;throw a;})},get _getGroups(){return g(this,function(a){return a._groups})},get _setGroups(){return g(this,function(a,b){a=G("readonly attribute");a.__cause__=null;throw a;})},get _getGroupIndex(){return g(this,function(a){return null===a._groupindex?A({}):a._groupindex})},get _setGroupIndex(){return g(this,function(a,b){a=G("readonly attribute");a.__cause__=null;throw a;})},get _compileWrapper(){return g(this,function(a,b,d){if("undefined"==typeof d||
